...
class ModalTypoService:
    ...
    def get_recommendation_pro(self, record: Record, scores: dict) -> dict:
        ...
        data = {
            ...
            "fr_pro_loc": 5 if 'local' in record.data["trav_pro"] else 0,
            "fr_pro_reg": 5 if 'region' in record.data["trav_pro"] else 0,
            "fr_pro_int": 5 if 'inter' in record.data["trav_pro"] else 0,
