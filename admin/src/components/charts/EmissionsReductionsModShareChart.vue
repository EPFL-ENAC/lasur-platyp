        ...
        <q-menu>
          <q-list style="min-width: 200px">
            <q-item clickable v-close-popup @click="onToggleRedShareModalType">
              <q-item-section side>
                <q-icon :name="stats.redShareModalType === 'simple' ? 'pie_chart' : 'lens'" />
              </q-item-section>
              <q-item-section>
                <q-item-label>{{
...
import EmissionsReductionsShareChart from '@/components/charts/EmissionsReductionsShareChart.vue'
...
const detailedChartRef = ref<EmissionsReductionsShareChartExposed | null>(null)
