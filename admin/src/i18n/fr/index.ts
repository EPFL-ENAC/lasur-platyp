...
const complexLabels = {
  ...
  carpool: 'Covoiturage',
  other: 'Autre',
  'tp+bike': 'Transports publics + Vélo',
  'bike+tp': 'Vélo + Transports publics',
  'tp+car': 'Transports publics + Voiture',
  'car+tp': 'Voiture + Transports publics',
  'car+bike': 'Voiture + Vélo',
  'bike+car': 'Vélo + Voiture',
  'tp+walk': 'Transports publics + Marche',
  'walk+tp': 'Marche + Transports publics',
