...
const complexLabels = {
  ...
  carpool: 'Carpooling',
  other: 'Other',
  'tp+bike': 'Public transport + Bicycle',
  'bike+tp': 'Bicycle + Public transport',
  'tp+car': 'Public transport + Car',
  'car+tp': 'Car + Public transport',
  'car+bike': 'Car + Bicycle',
  'bike+car': 'Bicycle + Car',
  'tp+walk': 'Public transport + Walking',
  'walk+tp': 'Walking + Public transport',
...
- on participants’ health, via average daily energy expenditure (metabolic equivalent task) during their trips. The Swiss Confederation and the WHO recommend 150 minutes of moderate-intensity exercise (cycling/brisk walking) per week, equivalent to 150 kcal per day. [(source)](https://www.who.int/fr/news-room/fact-sheets/detail/physical-activity) A lack of physical activity has a direct impact on physical and mental health (psychological and cognitive), and thus directly affects employees’ well-being, sick leave rates, productivity and the working atmosphere.`,
    ...
    locations_heatmap: {
      ...
      description:
        'This chart shows the geographical distribution of participants’ households, as well as their workplaces. The households are grouped by area so as not to disclose any personal data. Click a workplace (or home area) to display the flows associated with that location; click it again, or press Escape, to reset.',
    },
    travel_time: {
      title: 'Your commute',
      description:
    ...
    emissions_freq_mod: {
      ...
      description:
        "This graph shows the emissions generated by each mode of transport used for the participants' commutes. The x-axis shows the number of journeys made using each mode of transport per year. The y-axis shows the carbon emissions per journey. Therefore, the area of each rectangle corresponds to the annual emissions for each mode of transport in tCO₂eq. These are calculated using Mobi-Tools emission factors, which are the benchmark in Switzerland ([link](https://www.i14y.admin.ch/fr/catalog/dataservices/171b09a4-5b5f-4577-8921-3af7fc6eee39/description)). ",
    ...
    energy_journey: {
      ...
      description_current:
        'This graph shows the daily energy expenditure associated with each participant’s commute to and from work, in kcal/day, based on the compendium of physical activities, which lists energy expenditure by activity and duration (link: https://pacompendium.com/). Each bar represents one participant.',
      title_reco: 'Potential Physical Activity Diagram following Recommendations',
      description_reco:
        'This graph shows the potential daily energy expenditure that would result from each participant’s commute to and from work, in kcal/day, assuming that all participants follow the recommendations made by Mobilyse. The energy expenditure figures are based on the compendium of physical activities, which provides energy expenditure figures by activity and duration. (link: https://pacompendium.com/). Each bar represents one participant.',
